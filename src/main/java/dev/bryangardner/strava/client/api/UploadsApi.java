...
import java.io.File;
import dev.bryangardner.strava.client.model.Upload;
...
@Component("dev.bryangardner.strava.client.api.UploadsApi")
public class UploadsApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Upload> createUploadWithHttpInfo(File file, String name, String description, String trainer, String commute, String dataType, String externalId) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Upload> getUploadByIdWithHttpInfo(Long uploadId) throws RestClientException {
        Object postBody = null;
