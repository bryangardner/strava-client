...
import dev.bryangardner.strava.client.model.DetailedGear;
...
@Component("dev.bryangardner.strava.client.api.GearsApi")
public class GearsApi {
     ...
     * <p><b>0</b> - Unexpected error.
     * @param id The identifier of the gear. (required)
     * @return ResponseEntity&lt;DetailedGear&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<DetailedGear> getGearByIdWithHttpInfo(String id) throws RestClientException {
