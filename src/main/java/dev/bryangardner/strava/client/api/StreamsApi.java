...
import dev.bryangardner.strava.client.model.StreamSet;
...
@Component("dev.bryangardner.strava.client.api.StreamsApi")
public class StreamsApi {
     ...
     * @param keys Desired stream types. (required)
     * @param keyByType Must be true. (required)
     * @return ResponseEntity&lt;StreamSet&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<StreamSet> getActivityStreamsWithHttpInfo(Long id, List<String> keys, Boolean keyByType) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<StreamSet> getRouteStreamsWithHttpInfo(Long id) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<StreamSet> getSegmentEffortStreamsWithHttpInfo(Long id, List<String> keys, Boolean keyByType) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<StreamSet> getSegmentStreamsWithHttpInfo(Long id, List<String> keys, Boolean keyByType) throws RestClientException {
        Object postBody = null;
