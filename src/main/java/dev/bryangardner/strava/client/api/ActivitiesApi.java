...
@Component("dev.bryangardner.strava.client.api.ActivitiesApi")
public class ActivitiesApi {
    ...
    public DetailedActivity createActivity(String name, String type, OffsetDateTime startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute) throws RestClientException {
        return createActivityWithHttpInfo(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute).getBody();
    }
     ...
     * @param trainer Set to 1 to mark as a trainer activity. (optional)
     * @param commute Set to 1 to mark as commute. (optional)
     * @return ResponseEntity&lt;DetailedActivity&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<DetailedActivity> createActivityWithHttpInfo(String name, String type, OffsetDateTime startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<DetailedActivity> getActivityByIdWithHttpInfo(Long id, Boolean includeAllEfforts) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<Comment>> getCommentsByActivityIdWithHttpInfo(Long id, Integer page, Integer perPage) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<SummaryAthlete>> getKudoersByActivityIdWithHttpInfo(Long id, Integer page, Integer perPage) throws RestClientException {
        Object postBody = null;
     ...
     * <p><b>0</b> - Unexpected error.
     * @param id The identifier of the activity. (required)
     * @return ResponseEntity&lt;List&lt;Lap&gt;&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<Lap>> getLapsByActivityIdWithHttpInfo(Long id) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<SummaryActivity>> getLoggedInAthleteActivitiesWithHttpInfo(Integer before, Integer after, Integer page, Integer perPage) throws RestClientException {
        Object postBody = null;
     ...
     * <p><b>0</b> - Unexpected error.
     * @param id The identifier of the activity. (required)
     * @return ResponseEntity&lt;List&lt;ActivityZone&gt;&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<ActivityZone>> getZonesByActivityIdWithHttpInfo(Long id) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<DetailedActivity> updateActivityByIdWithHttpInfo(Long id, UpdatableActivity body) throws RestClientException {
