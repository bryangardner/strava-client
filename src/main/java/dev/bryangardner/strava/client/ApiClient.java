package dev.bryangardner.strava.client;
...
import dev.bryangardner.strava.client.auth.Authentication;
import dev.bryangardner.strava.client.auth.HttpBasicAuth;
import dev.bryangardner.strava.client.auth.ApiKeyAuth;
import dev.bryangardner.strava.client.auth.OAuth;


@Component("dev.bryangardner.strava.client.ApiClient")
